...
public class WmNewsServiceImpl  extends ServiceImpl<WmNewsMapper, WmNews> implements WmNewsService {
     ...
     */
    @Override
    public ResponseResult<WmNews> getNewById(Integer id) {
        //先查询文章是否存在
     ...
     */
    @Override
    public ResponseResult<WmNews> delNewById(Integer id) {
        //校验参数
        if(id==null){
        ...
        if(wmNews.getStatus().equals(WmNews.Status.PUBLISHED)){
            return ResponseResult.errorResult(AppHttpCodeEnum.PARAM_INVALID,"文章已经发布不能删除");
        }
        //根据文章id删除文章
